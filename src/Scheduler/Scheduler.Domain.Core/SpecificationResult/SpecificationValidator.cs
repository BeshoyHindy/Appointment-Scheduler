...
using Scheduler.Domain.Core.SpecificationResult.Result;
using Scheduler.Domain.Core.SpecificationResult.Validation;

namespace Scheduler.Domain.Core.SpecificationResult
{
